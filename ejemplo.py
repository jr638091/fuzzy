...
# m.add_rule('tenderos is lenta', lambda x: 100)
# m.add_rule('cola is larga', lambda x: 100)
# m.add_rule('cola is normal and tenderos is normal', lambda x, y: x*y)
m.add_rule('tenderos is lenta', 'bronca is alta')
m.add_rule('cola is larga', 'bronca is alta')
m.add_rule('cola is normal and tenderos is normal', 'bronca is alta')
